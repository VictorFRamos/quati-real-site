      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-olive-800 text-stone-100 rounded-lg p-6 sm:p-10 shadow-lg border border-olive-900 relative overflow-hidden flex flex-col md:flex-row items-center justify-between">
          ...
          <a
            ...
            className="relative z-10 w-full md:w-auto inline-flex items-center justify-center space-x-2 bg-gradient-to-r from-amber-500 to-amber-500 hover:from-amber-400 hover:to-amber-400 text-neutral-950 font-mono text-xs font-bold uppercase tracking-widest py-3 px-6 rounded shadow"
          >
